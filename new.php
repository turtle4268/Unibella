        ...
        <div class="sec2_a">
            ...
            <section class="newText_a">
                ...
                <div class="newP_a" id="text1">
                    ...
                    想驚艷就得高明度别以為只有服裝才可以高明度，傘界現在也正流行。
                    要知道選對一把色彩明豔的傘可以勝過配飾的，美國歌壇小天后蕾哈娜就經常在傘上下足功夫，
                    而歌手兼設計師的格温-斯蒂芬妮則是绝對的色彩搭配高手。
                    </p>
                </div>
                ...
                <div class="newP_a" id="text3">
                    <p>Unibella
                    為了研發能長久使用的產品，我們避免慣性妥協，特別是製造商經常與客戶達成最低價格的合作，
                    工廠將為節省資金和提高效率。他們可能會改變供應商在材料上的細微差別，
                    或抵制生產中的太多質量的檢查，忽略產品的某種美感以簡化裝配。
                    這些妥協可能看起來很小，但總體上它們會對產品產生重大影響。
                    當你被要求妥協時，必須堅持材料的真實性，並尋找方法來改善您的產品組裝方式，
                    同時不犧牲那些重要且通常很小的設計細節。 
                    在生產開始時實施質量控制計劃，而不是結束，</p>
                </div>
