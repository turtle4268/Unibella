            ...
            <div class="qaContent_a">
                ...
                <ul>
                    ...
                    <li class="questionP_a">
                        ...
                        <br>現貨商品:3-5個工作天
                        <br>預購商品:20-25個工作天
                        <br>※ 訂單內若有現貨和預購商品，需等商品皆到貨後才會安排出貨，若需分批出貨請分開成立訂單。
                        <br>※ 工作天不包含六、日與國定假日。
                        </p>
                    </li>
                </ul>
                ...
                <ul>
                    ...
                    <li class="questionP_a">
                        ...
                        <br>
                        ※辦理退換後宅配聯繫多次並超過十天收不回商品者本公司有權利取消此退貨並不予換款。
                        <br>
                        ※在收到退回商品時，如遇不符換貨規範，Unibella會將商品寄回，屆時運費尚須由消費者自行負擔。（來回運費為120元）
                        </p>
                    </li>
                    ...
                    <li class="questionP_a">
                        ...
                        <br>
                        <br>※注意事項※
                        <br>退款帳戶請於退貨時自行登入會員中心填寫退款資訊，如因資料錯誤而造成退款時間延誤，本司概不負責。
                        </p>
                    </li>
